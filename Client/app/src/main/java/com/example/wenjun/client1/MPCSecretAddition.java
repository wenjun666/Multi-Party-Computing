...
public class MPCSecretAddition {
    private int secret;
    ...
    public MPCSecretAddition() {

    }

    public MPCSecretAddition(int SERVERPORT, String SERVER_IP, int numParties, int secret) {
    ...
    public int sendMessage(){
        ...
        */
        ...
        //String entered = textToBeEncrypted.getText().toString();
        ...
        */
        ...
        /*while (!combineShareReceivedFlag){
        ...
        */
        ...
        this.result = a.combine(combineReceived);
